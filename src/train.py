...
def train(net, data, loss_fn, trainer, ctx, epochs, checkpoint_dir):
    ...
    for epoch in range(epochs):
        metric = IouMetric()
        for i, (batch, labels) in enumerate(train_iter): #tqdm(enumerate(train_iter), desc='Epoch {}'.format(epoch)):
        ...
        print("Epoch {} | train IoU {} | val IoU {}".format(epoch, train_iou, val_iou))
        metric.reset()
